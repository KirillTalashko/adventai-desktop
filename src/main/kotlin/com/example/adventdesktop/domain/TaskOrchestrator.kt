...
class TaskOrchestrator(
    ...
    private companion object {
        ...
        const val INTERVIEWER = "Ты — ИНТЕРВЬЮЕР. Этап INTAKE. Цель — БЫСТРО довести до плана, не зацикливаясь на " +
            ...
            "Запрос про ДАЙДЖЕСТ (подписать страну на периодический дайджест, показать/обновить сводку, список подписок) — " +
            "тоже информационный и НЕ задача-процесс: вызови нужный инструмент (add_digest_country / list_digest_countries / " +
            "get_visa_digest), покажи результат и заверши [SIMPLE] (план НЕ нужен).\n" +
