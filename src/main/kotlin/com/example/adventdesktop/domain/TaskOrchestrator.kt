...
class TaskOrchestrator(
    ...
    private companion object {
        ...
        const val PLANNER_PLAN = "Ты — ПЛАНИРОВЩИК. Этап PLANNING, построение плана.\n" +
            "В [STATE] есть «Выбранный подход». Построй пошаговый план (4–7 шагов) ИМЕННО под этот подход. Каждый шаг — " +
            "одна строка, глагол в начале, по порядку. Верни СТРОГО блок:\n[PLAN]\n1. …\n2. …\n[/PLAN]"
