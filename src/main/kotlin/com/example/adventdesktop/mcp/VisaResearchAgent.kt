...
done=true только если ключевое (нужна ли виза, куда подавать, документы, сборы/сроки) подтверждено
официально ИЛИ дальнейший поиск явно бесполезен.
""".trim()
...
Правила:
1. Статус визы (нужна / безвиз N дней / eVisa / Шенген) — из источников; цитируй КОНКРЕТНЫЕ
   официальные URL (помеченные [офиц.] — приоритет). Не выдумывай факты вне источников.
2. Куда подавать — официальный портал/визовый центр из источников (ссылкой).
...
Структура:
• Нужна ли виза: …  [источник]
• Куда подавать: … (ссылка)
• Документы: …  [источник]
• Сборы и сроки: …  [источник]
• Пробелы (уточнить на офиц. сайте): …
• По состоянию на: <дата> · Источники: <url, url>
